...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function tna($str)
        {
                        return \Illuminate\Support\Str::tna($str);
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Support\Collection::squared();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function plus($number)
        {
                        return \Illuminate\Support\Collection::plus($number);
        }
